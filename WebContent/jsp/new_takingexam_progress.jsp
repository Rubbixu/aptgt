	...
	<h3>Watch these videos to help take your exam:</h3>
		...
		<br>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" id="ta"
						placeholder="Enter your answer by clicking the keyboard above." name="studentanswer"  readonly="true" value=<%if(answer != null){ out.print(answer); }%> >
				</div>
			<!--  	<div class="col-sm-3">
					<button 
			...
			-->	
				...
				<div class="col-sm-6"> 
					<button id="Previous" type="submit" name="button" value="buttonPre" <%if(current==0){ %>style="display:none"<% }%> class="w3-button w3-teal w3-round-large w3-center arrow right" 
