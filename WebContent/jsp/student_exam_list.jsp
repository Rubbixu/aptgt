...
<title>Exams | Your Site Title Here</title>
...
<li>
        ...
        <a href="${pageContext.request.contextPath }/student?method=studentexamlist&lid=<% out.print(l.getLid());%>">
  ...
  <main class="page-holder" data-animation="54">
   ...
   <div class="pages ay-spinner2" data-animation="54">
      <div id="ap-Exams.html" class="page ay-current" data-pos="/Exams.html">
 <section class="color-1 ss-style-doublediagonal" >
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <h1 class="page-title"><%out.print(l.getName()); %></h1>
            ...
            <div class="listallco">
              ...
              <c:forEach items="${sexams }" var="item" varStatus="counter">
                <div id="view1">
						...
						<a>${item.exam.edue }</a>
						<a>${item.exam.uname }</a>
						<a style="color: blue" href="${pageContext.request.contextPath }/student?method=takeexam&lid=<%out.print(l.getLid()); %>&eid=${item.exam.eid}">${item.showAction}</a>
