...
public class StudentServletDoneWithFixSaveButton2 extends HttpServlet {
...
//		resp.getWriter().write(""+barChart.toString() + "," + pieChart.toString() + ","+position.toString());
	...
	private void studentTakeExamSpe(HttpServletRequest req, HttpServletResponse resp)
		...
		String buttonType = req.getParameter("button");
		System.out.println(buttonType + " from SPE");
		
//		if (buttonType != null) {
//			if (buttonType.equals("buttonNext")) {
//				current++;
//			} else if (buttonType.equals("buttonPre")) {
//				current--;
//			} else if (buttonType.equals("buttonSubmit")) {
//				studentSubmitResult(req, resp);
//			}
//		} 
		
		if (buttonType != null && buttonType.equals("buttonSubmit")) {

			studentSubmitResult(req, resp);
		} else  {
			if (buttonType != null && buttonType.equals("buttonNext")) {
				current++;
			} else if (buttonType != null && buttonType.equals("buttonPre")) {
				current--;
			}
	...
	//		id = req.getParameter("current");
	//		int current = Integer.parseInt(id);
			System.out.println("From SPE "  + current);
			Exam exam = examService.getExamById(eid);
			List<ExamWord> words = wordService.getAllWordsByEid(eid);
...
//		
//		String currentNum = req.getParameter("current");
//		System.out.println(currentNum);
//		int current = Integer.parseInt(currentNum);
//		
//		if (opid.equals("buttonNext")) {
//			current++;
//			System.out.println("test");
//		} else if (opid.equals("buttonPrev")) {
//			current--;
//		} 
