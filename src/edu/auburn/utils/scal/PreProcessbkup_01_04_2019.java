...
public class PreProcessbkup_01_04_2019 {
...
//					i += 2;
				if (i + 3 < str.length()
						&& Arrays.asList(phonetic.getDicritics2()).contains(String.valueOf(str.charAt(i + 3)))) {
					temp += str.charAt(i + 3);
					i++;
				}
				res.add(temp);
				i += 2;
					...
					&& Arrays.asList(phonetic.getDicritics1()).contains(String.valueOf(str.charAt(i)))) {
				temp += str.charAt(i + 1);
				if (i + 2 < str.length()
						&& Arrays.asList(phonetic.getDicritics2()).contains(String.valueOf(str.charAt(i + 2)))) {
					temp += str.charAt(i + 2);
					i++;
				}
				res.add(temp);
				i++;
					...
					&& Arrays.asList(phonetic.getDicritics2()).contains(String.valueOf(str.charAt(i + 1)))) {
